...
namespace RevolutionGames.Game
{
    public class BallCollisionHandler : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (this.rb.linearVelocity.magnitude >= 0.05f)
            {
        ...
        public void OnCollisionEnter(Collision collision)
        {
            ...
            else if ((gameManager.CurrentGameState == GameManager.GameState.isItCueballBreak || gameManager.CurrentGameState == GameManager.GameState.isItCueballBreakDone))
            {
                ...
                {
                    secondVel = collision.gameObject.GetComponent<CueBallCollisionHandler>().VelocityBeforePhysicsUpdate;
                }
                else
                {
                    secondVel = collision.gameObject.GetComponent<BallCollisionHandler>().VelocityBeforePhysicsUpdate;
                }
